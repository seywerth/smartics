...
/**
 * entity for accessing metering data (rough, by minutes) from the database.
 * - has startTime and untilTime
 * - values are now in Wh
 * 
 * @author Raphael Seywerth
 *
 */
@Entity
@Table(name = "meteringDataMin")
public class MeteringDataMin extends MeteringDataArchiveBase {
	...
	private MeteringDataMin() {
		super();
	}

	public MeteringDataMin(final Timestamp startTime,
	...
	public boolean equals(Object obj) {
		...
		MeteringDataMin other = (MeteringDataMin) obj;
		if (startTime == null) {
